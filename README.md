...
<p align="center"><strong>Business of Agents (BOA)</strong> — Model: Business of Agents.</p>
...
openboa is an open-source runtime for building a **Business of Agents (BOA)** through the *Business of Agents* model: a durable business entity that runs through autonomous agents while remaining accountable to a human operator.
...
### Business of Agents
Business of Agents is a design stance.
