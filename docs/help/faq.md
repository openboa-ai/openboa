...
<AccordionGroup>
  <Accordion title="What is openboa?">
    openboa is a Business of Agents (BOA) system. It keeps the business as the durable operating subject and treats agents as an evolvable workforce.
  </Accordion>
  ...
  <Accordion title="How should I start reading?">
    Start with Introduction, then Business of Agents, Core Doctrine, and Architecture. After that, read the surface docs in order: Agent, Chat, Work, and Observe.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Business of Agents" href="/concepts/business-of-agents">
